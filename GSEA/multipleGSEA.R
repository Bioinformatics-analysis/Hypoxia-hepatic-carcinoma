...
# To run the GSEA, you should downloaded the GSEA software from the https://www.gsea-msigdb.org/gsea/index.jsp. 
#Then, based on the risk group, run the GSEA enrichment analysis and obtained the significantly pathway
#Finally, you can used the script to draw the Figure
library(plyr)
library(ggplot2)
library(grid)
library(gridExtra)
...
gseaCol=c("#58CDD9","#6E568C","#E0367A","#D8D155","#64495D","#7CC767","#223D6C","#D20A13","#FFD121","#088247","#11AA4D")
